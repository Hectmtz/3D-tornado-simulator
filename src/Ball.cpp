...
void Ball::setBall(double pos_x, double pos_y, double pos_z, double r, double g, double b)
{
    this->pos_x = pos_x;
    this->pos_y = pos_y;
    this->pos_z = pos_z;
    this->box_1.setObject("models/rock.ply", r, g, b);
    this->b_angle = 0;
    this->box_1.setMaterial(1.5, 2.0);
    // ka, kd
    //ka = material
    //kd = cantidad de luz que refleja
}

void Ball::draw(arma::Mat<double> matrix, double Ia, double Ip, arma::vec F)
{
    Transform tr;
